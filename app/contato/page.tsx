    ...
    <main className="relative min-h-screen bg-[#050505] overflow-hidden text-white font-sans selection:bg-white selection:text-[#C1121F]">
      ...
      <div className="relative z-10 min-h-screen flex flex-col max-w-screen-2xl mx-auto md:px-8 px-4 py-6">
        ...
        <div className="flex-grow flex items-center justify-center flex-col text-center">
          <h1 className="text-5xl md:text-7xl font-bold uppercase tracking-tighter mb-6">Contato</h1>
          <p className="text-white/60 max-w-lg leading-relaxed mb-8">
            Fale conosco. Nossa equipe está pronta para transformar a sua visão em realidade.
          </p>
          <a href="mailto:contato@exemplo.com" className="bg-white text-black px-8 py-3 rounded-full uppercase tracking-wider font-semibold text-sm hover:bg-gray-200 transition-colors">
            Enviar Email
          </a>
        </div>
      </div>
