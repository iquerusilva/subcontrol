  ...
  return (
    <main className="relative min-h-screen bg-[#050505] overflow-hidden text-white font-sans selection:bg-white selection:text-[#C1121F]">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute top-[35%] lg:top-[10%] left-1/2 -translate-x-1/2 w-[150vw] sm:w-[600px] lg:w-[850px] h-[40vh] lg:h-[80vh] flex items-center justify-center mix-blend-luminosity opacity-90 pointer-events-none">
